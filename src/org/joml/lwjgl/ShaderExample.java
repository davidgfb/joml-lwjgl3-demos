...
public class ShaderExample {
    ...
    void init() {
        ...
        glfwSetWindowRefreshCallback(window, wrCallback = new GLFWWindowRefreshCallback() {
			@Override
			public void invoke(long paramLong) {
				render();
			}
		});
        glfwSetWindowSizeCallback(window, wsCallback = new GLFWWindowSizeCallback() {
			@Override
			public void invoke(long paramLong, int paramInt1, int paramInt2) {
				render();
			}
		});
    ...
    void render() {
        ...
        viewProjMatrix.setPerspective(45.0f, (float)width/height,
                                      0.01f, 100.0f)
        ...
        viewProjMatrix.rotate(angle, 0.0f, 1.0f, 0.0f)
